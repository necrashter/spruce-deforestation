...
import com.spruce.game.world.entities.Celebrator;
...
public class GameFinishedLevel extends GameWorld {
    public GameFinishedLevel(SpruceGame game, int level, float easiness) {
        ...
        player.addWeapon(SpruceGame.assets.createAutoRifle(player), true);
