...
import com.spruce.game.world.entities.L4PistolSuit;
import com.spruce.game.world.entities.L4RifleSuit;

public abstract class PhaseSurvivalLevel extends GameWorld {
    L4PistolSuit.Pool pistolSuitPool;
    L4RifleSuit.Pool rifleSuitPool;

    public PhaseSurvivalLevel(SpruceGame game, int level, float easiness) {
