...
import com.mygdx.game.world.GameWorldRenderer;
import com.mygdx.game.world.LowResWorldRenderer;
import com.mygdx.game.world.levels.ScriptedEvent;
...
public class GameScreen implements Screen {
    ...
    public GameScreen(final MyGdxGame game, final GameWorld world) {
        this.game = game;
...
//        worldRenderer = world;
        ...
        {
            hurtOverlay = new Image(MyGdxGame.assets.hurtOverlay);
...

        {
            ...
            Texture crosshairTexture = MyGdxGame.assets.get("crosshair010.png");
...

        {
            ...
            final Image backgroundImage = new Image(MyGdxGame.assets.bottomGrad);
...
//        stringBuilder.append('\n');
    ...
    public void setPaused(boolean v) {
        ...
        world.paused = v;
        if (!MyGdxGame.isMobile()) Gdx.input.setCursorCatched(!world.paused);
        if (world.paused) {
            MyGdxGame.music.paused();
        } else {
            MyGdxGame.music.resumed();
