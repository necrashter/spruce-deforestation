...
public class L4RifleSuit extends NPC implements Pool.Poolable {
    ...
    public L4RifleSuit(GameWorld world) {
        super(world);
        modelInstance = new ModelInstance(MyGdxGame.assets.npcModel, "ManArmature", "Suit", "autorifle");
            ...
            return new L4RifleSuit(level) {
                ...
                public boolean onRemove(boolean worldDisposal) {
                    ...
                    if (firstKill) {
                        ...
                        octree.add(MyGdxGame.assets.createAutoRiflePickup(world.player, pickupPos).spawnAnimation());
                        firstKill = false;
                    } else {
