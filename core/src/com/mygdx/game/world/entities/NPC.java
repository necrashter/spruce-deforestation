...
import com.mygdx.game.world.decals.DecayingDecal;
import com.mygdx.game.world.geom.RayIntersection;
import com.mygdx.game.world.objects.TreeObject;
...
public class NPC extends GameEntity {
    ...
    public boolean onRemove(boolean worldDisposal) {
        ...
        if (MathUtils.randomBoolean()) {
            ...
            octree.add(MyGdxGame.assets.createHealthPickup(pickupPos).spawnAnimation());
        }
        return true;
    }
...
//            if (moveCheck.normal.dot(movement) < 0) moveCheck.normal.scl(-1);
    ...
    private final DecayingDecal decal = DecayingDecal.newDecayingDecal(MyGdxGame.assets.muzzleFlashRegion, true);
...
//                movement.setZero();
    ...
    class PistolShoot extends State {
        ...
        public void init() {
            ...
            showDecal();
            world.playSound(MyGdxGame.assets.enemyPistol, ray.origin);
    ...
    class RifleShoot extends State {
        ...
        public void init() {
            ...
            world.playSound(MyGdxGame.assets.enemyRifle, ray.origin);
            remaining = burst;
        }
