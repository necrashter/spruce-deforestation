...
public class Axe extends PlayerWeapon {
    ...
    public Axe(Player player) {
        super(player);
        this.viewModel = new ModelInstance(MyGdxGame.assets.allModel, "axe");
    }
    ...
    public void update(float delta) {
        ...
        if (noSoundYet && swingRotation > 0.5f) {
            noSoundYet = false;
            MyGdxGame.assets.swooshes[MathUtils.random.nextInt(MyGdxGame.assets.swooshes.length)].play();
        }
