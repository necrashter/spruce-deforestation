...
import com.mygdx.game.world.entities.L4Sainta;
import com.mygdx.game.world.objects.FakeTreeObject;
...
public class L4Destruction extends PhaseSurvivalLevel {
    ...
    public L4Destruction(MyGdxGame game, int level, float easiness) {
        ...
        FakeTreeObject fakeTree = new FakeTreeObject(MyGdxGame.assets.metalSpruceTemplate) {
            @Override
            public void remove() {
