...
import com.mygdx.game.world.entities.Everyman;
import com.mygdx.game.world.entities.L1Suit;
...
public class L1WoodChopping extends SuitMissionLevel {
    public L1WoodChopping(MyGdxGame game, final int level, float easiness) {
...
//        octree.node.printObjectCounts(0);
    ...
    public void addedToScreen() {
        ...
        MyGdxGame.music.start(MyGdxGame.music.darkMusic);
    }
}
