...
import com.mygdx.game.world.entities.Captive;
import com.mygdx.game.world.entities.L3Sainta;
import com.mygdx.game.world.entities.L3Suit;
import com.mygdx.game.world.entities.NPC;
import com.mygdx.game.world.entities.PistolWanderer;
...
public class L3SaintaClaus extends GameWorld {
    ...
    public L3SaintaClaus(MyGdxGame game, int level, float easiness) {
        ...
        suit = new L3Suit(this) {
            ...
            public boolean onRemove(boolean worldDisposal) {
                ...
                octree.add(MyGdxGame.assets.createPistolPickup(world.player, pickupPos).spawnAnimation());
        ...
        setScriptedEvent(cutscene(
                ...
                new ScriptedEvent.OneTimeEvent() {
                    ...
                    public void activate() {
                        ...
                        MyGdxGame.music.start(MyGdxGame.music.actionMusic);
                    }
                }
        ));
    }
